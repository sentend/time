...
import { ColorPalette, ColorOptions } from "@/shared/ui/color-palette";
import { projectSchema, type ProjectFormData } from "@/pages/projects-page/project-schema";
import { Form, FormControl, FormField, FormItem, FormLabel, InputField } from "@/shared/ui/form";
...
export const EditProjectForm = ({ onSubmit, initialValues, isDisabled }: ProjectEditorProps) => {
	...
	const { register, formState, control, setValue, setFocus } = formMethods;
	...
	const handleColorPaletteChange = ({ colorIndex }: ColorOptions) => {
		setValue("colorId", colorIndex);
	};

	const handleSubmit: SubmitHandler<ProjectFormData> = (values) => {
	...
	return (
		<Form
			...
			id="project-form"
		>
			<div ref={setFocusName} className="space-y-4">
								...
								<FormItem>
									...
									<FormControl>
										<ColorPalette
											...
											onColorSelect={handleColorPaletteChange}
										/>
									</FormControl>
								</FormItem>
							)}
